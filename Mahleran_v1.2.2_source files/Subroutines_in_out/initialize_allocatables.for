c****************************************************************
       subroutine initialise_allocatables
c****************************************************************
       ...
       do i = 1, nr2
          do j = 1, nc2
             ...
             aspect (i, j) = 0
             veg (i, j) = 0.0d0
cLTOct2007 added in initialise theta_0 and theta_sat
             theta_0 (i, j) = 0.0d0
             theta_sat (i, j) = 0.0d0
             sminit (i, j) = 0.0d0
             ciinit (i, j) = 0.0d0
...
cLTOct2007 here k varies from 1 to 2. If K = 1 value from previous time step
c if k = 2, value updated in current time step.
                d (k, i, j) = 0.0d0
                q (k, i, j) = 0.0d0
                qin (k, i, j) = 0.0d0
c need to change it where the balance eq. is all this does is reset all allocatable variables to 0 when 1st set up.
...
!            ff (i, j) = 0.0d0
             ...
             depos_tot (i, j) = 0.0d0
c
cLTOct2007 added in particulate nutrients
c
             amm_tot (i, j) = 0.0d0
             nit_tot (i, j) = 0.0d0
             TN_tot (i, j) = 0.0d0
